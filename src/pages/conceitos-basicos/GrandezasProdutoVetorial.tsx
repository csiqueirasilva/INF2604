...
function InternalRenderingComponent () {
    ...
    useEffect(() => {
        setSoma(v1.clone().cross(v2.clone()));
    }, [ v1, v2 ]);
    ...
    return (
        <>
            ...
            <ReadOnlyRenderVector name="v1 x v2" value={soma} color={"yellow"} />
        </>
    );
}

export default function GrandezasProdutoVetorial() {

    return (
        <>
            <HeaderWithBackButton title="Conceitos Básicos - Produto Vetorial" />
